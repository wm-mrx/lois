...
router.get(config.api + 'role/get', auth.isAuthenticated, function (req, res) {
...
router.get(config.api + 'role/getAll', auth.isAuthenticated, function (req, res) {
...
router.post(config.api + 'role/save', auth.isAuthenticated, function (req, res) {
...
router.delete(config.api + 'role/delete', auth.isAuthenticated, function (req, res) {
