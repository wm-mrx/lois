...
Controller.prototype.get = function (id) {
    return schemas.drivers.findOne({ "_id": ObjectId(id) }).exec();
};
...
Controller.prototype.getAll = function (query) {
    ...
    var entities = schemas.drivers.find(parameters);
...
Controller.prototype.save = function (data) {
    var entity = new schemas.drivers(data);

    if (!data['_id'])
        return entity.save();

    return schemas.drivers.update({ "_id": entity._id }, entity);
};
