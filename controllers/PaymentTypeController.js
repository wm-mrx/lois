...
Controller.prototype.get = function (id) {
    return schemas.paymentTypes.findOne({ "_id": ObjectId(id) }).exec();
};
...
Controller.prototype.getAll = function (query) {
    ...
    var entities = schemas.paymentTypes.find(parameters);
...
Controller.prototype.save = function (data) {
    var entity = new schemas.paymentTypes(data);

    if (!data['_id'])
        return entity.save();

    return schemas.paymentTypes.update({ "_id": entity._id }, entity);
};

Controller.prototype.delete = function (id) {
    return co(function* () {
        var entity = schemas.paymentTypes.findOne({ "_id": id }).exec();
