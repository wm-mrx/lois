...
Controller.prototype.get = function (id) {
    return schemas.menus.findOne({ "_id": ObjectId(id) }).exec();
};
...
Controller.prototype.getAll = function (query) {
    ...
    var entities = schemas.menus.find(parameters);
...
Controller.prototype.save = function (data) {
    var entity = new schemas.menus(data);

    if (!data['_id'])
        return entity.save();

    return schemas.menus.update({ "_id": entity._id }, entity);
};

Controller.prototype.delete = function (id) {
    return co(function* () {
        var entity = schemas.menus.findOne({ "_id": ObjectId(id) });
