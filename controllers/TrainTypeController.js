...
Controller.prototype.get = function (id) {
    return schemas.trainTypes.findOne({ "_id": ObjectId(id) }).exec();
};
...
Controller.prototype.getAll = function (query) {
    ...
    var entities = schemas.trainTypes.find(parameters);
...
Controller.prototype.save = function (data) {
    var entity = new schemas.trainTypes(data);

    if (!data['_id'])
        return entity.save();

    return schemas.trainTypes.update({ "_id": entity._id }, entity);
};

Controller.prototype.delete = function (id) {
    return co(function* () {
        var entity = schemas.trainTypes.findOne({ "_id": id }).exec();
