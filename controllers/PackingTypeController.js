...
Controller.prototype.get = function (id) {
    return schemas.packingTypes.findOne({ "_id": ObjectId(id) }).exec();
};
...
Controller.prototype.getAll = function (query) {
    ...
    var entities = schemas.packingTypes.find(parameters);
...
Controller.prototype.save = function (data) {
    var entity = new schemas.packingTypes(data);

    if (!data['_id'])
        return entity.save();

    return schemas.packingTypes.update({ "_id": entity._id }, entity);
};

Controller.prototype.delete = function (id) {
    return co(function* () {
        var entity = schemas.packingTypes.findOne({ "_id": id }).exec();
