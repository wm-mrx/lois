...
Controller.prototype.get = function (id) {
    return schemas.clients.findOne({ "_id": ObjectId(id) }).exec();
};
...
Controller.prototype.getAll = function (query) {
    ...
    var entities = schemas.clients.find(parameters);
...
Controller.prototype.save = function (data) {
    var entity = new schemas.clients(data);

    if (!data['_id'])
        return entity.save();

    return schemas.clients.update({ "_id": entity._id }, entity);
};

Controller.prototype.delete = function (id) {
    return co(function* () {
        var entity = schemas.clients.findOne({ "_id": id }).exec();
